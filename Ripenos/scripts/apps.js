...
function minFiles(){
    ...
    = " transform 0.3s ease-out, opacity 0.3s ease-out , visibility 0.3s ease-out, border-radius 0.3s ease-out,  width 0.3s ease-out,  height 0.3s ease-out, top 0.3s ease-out, left 0.3s ease-out"    
...
function maxFiles(){
    ...
    document.getElementById("files").style.transition 
    = " transform 0.3s ease-out, opacity 0.3s ease-out , visibility 0.3s ease-out, border-radius 0.3s ease-out,  width 0.3s ease-out,  height 0.3s ease-out"    
...
function closeFiles(){
    ...
    document.getElementById("myripebarM").style.borderRadius= "5px 5px  0 0";    document.getElementById("myripebarM").style.width= "98%";
...
document.getElementById("myripebarM").style.borderTop = " var(--primary-border)";
    ...
    moveToFront(document.getElementById("Windows"))
    actionbarDown();
}
...
// APPS - Camera
function minCam(){
    document.getElementById("Camera").style.transform= "translate(-50%, -50%) scale(0)";
    document.getElementById("Camera").style.visibility= "hidden";
    document.getElementById("Camera").style.opacity= "0";
    document.getElementById("Camera").style.top= "100%";
...
function maxCam(){
    ...
    document.getElementById("Camera").style.transform= "translate(-50%, -50%) scale(1)";
    }
    else{
        document.getElementById("Camera").style.top= "50%";
        document.getElementById("Camera").style.left= "50%";
...
// APPS - Document
function minDoc(){
    document.getElementById("Document").style.transform= "translate(-50%, -50%) scale(0)";
    document.getElementById("Document").style.visibility= "hidden";
    document.getElementById("Document").style.opacity= "0";
    document.getElementById("Document").style.top= "100%";
...
function maxDoc(){
    ...
    document.getElementById("Document").style.transform= "translate(-50%, -50%) scale(1)";
    }
    else{
        document.getElementById("Document").style.top= "50%";
        document.getElementById("Document").style.left= "50%";
