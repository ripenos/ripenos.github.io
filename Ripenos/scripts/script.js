...
document.getElementById("blurBtn").addEventListener("click", () => {
  if (document.getElementById("blur-backup").style.height == "0px") {
    ...
    document.getElementById("blur-backup").style.height = "0px"
    document.documentElement.style.setProperty("--primary-bg", "#1c1c1c");
  }
});
